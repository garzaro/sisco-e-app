  ...
  return (
    <button
      ...
      className={cn(
        ...
        "ease-linear group-data-[side=left]:-right-4 group-data-[side=right]:left-0 after:absolute after:inset-y-0 " +
        "after:left-1/2 after:w-[2px] sm:flex",
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "font-medium outline-hidden transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 " +
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        " min-w-0 -translate-x-px items-center gap-2 overflow-hidden rounded-md px-2 outline-hidden " +
